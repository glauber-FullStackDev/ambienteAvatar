...
[`wan-animate-2/`](wan-animate-2/README.md). Os onze workflows LTX incluem IA2V,
ID-LoRA, TalkVid, Best Face-ID, IA2V + LoRA pessoal, A2V + LoRA pessoal sem
imagem de entrada, o Ingredients IA2V corrigido e seu legado, o Ingredients
oficial single-stage, uma variante Ingredients WanGP I2V de 15 segundos e LTX
2.5 IA2V destilado; eles ficam em [`ltx-2.3/`](ltx-2.3/README.md). Cada imagem possui sua propria
